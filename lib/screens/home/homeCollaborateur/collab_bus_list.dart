...
class CollabBusList extends StatelessWidget {
  CollabBusList({Key? key}) : super(key: key);
    ...
    return Container(
      child: Column(
        ...
        children: [
              ...
              child: Column(
                children: [
                  ...
                  CustomButton(
                    ...
                    onTap: () => changeStationDialog(context, controller),
                  ),
                ],
              ),
            ),
          ...
          //  Bus Card
          getBusCards(controller.circuitList
              // .where((e) => !e.available)
              // .toList()
              )
        ],
